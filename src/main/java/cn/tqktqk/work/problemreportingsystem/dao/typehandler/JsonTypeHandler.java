package cn.tqktqk.work.problemreportingsystem.dao.typehandler;
 ...
 *
 * @author ：涂齐康
 * @date ：Created in 2020/5/30 2:29 下午
 * @description：
 * @modified By：
 * @version:
 */
...
//    }
    ...
    public void setNonNullParameter(PreparedStatement ps, int columnIndex, T parameter, JdbcType jdbcType) throws SQLException {
        try {
            ps.setString(columnIndex, objectMapper.writeValueAsString(parameter));
        } catch (JsonProcessingException e) {
            e.printStackTrace();
        }
